...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="pdet.html" class="nav-item nav-link active">Pet Details</a>
    ...
    <div class="container py-5">
        <div class="row py-5">
		<h4 class="text-secondary mb-3">View Pet Details</h4>
		<table id="customers" border="1" cellpadding="5" cellspacing="5">
				  <tr>
					...
					$sql="select * from pdet where oname='$username'";
