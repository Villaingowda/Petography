        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="upload.html" class="nav-item nav-link active">Upload Product</a>
...
<a href="priceup.php"><button type="button" class="btn btn-info">Update Price</button></a>               
			   <h4 class="text-secondary mb-3">Update Price</h4>
				
                <form name="f" method="post" action="priceup2.php">

								<div class="form-group">
								<label>id:</label>
								<input type="text" class="form-control" name="t2" required value="<?php echo $id; ?>">
								</div>
								
								<div class="form-group">
								<label>Product Name:</label>
								<input type="text" class="form-control" name="t3" required value="<?php echo $pname; ?>">
								</div>
								
								<div class="form-group">
								<label>Product Category:</label>
								<input type="text" class="form-control" name="t4" required value="<?php echo $pcat; ?>">
								</div>
								
								<div class="form-group">
								<label>Price:</label>
								<input type="number" class="form-control" name="t5" required value="<?php echo $price; ?>">
								</div>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <p><i class="fa fa-phone-alt mr-2"></i>+91 702805512</p>
