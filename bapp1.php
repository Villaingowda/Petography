    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                <h4 class="text-secondary mb-3">Book Appointment</h4>
                <h1 class="display-4 mb-4"><span class="text-primary">Search</span> <span class="text-secondary">Vet</span></h1>
                <form name="f" method="post" action="bapp2.php">
