...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="vdet.php" class="nav-item nav-link active">Vaccination Details</a>
    ...
    <div class="container py-5">
        <div class="row py-5">
		<h4 class="text-secondary mb-3">View Vaccination Details</h4>
		<table id="customers" border="1" cellpadding="5" cellspacing="5">
				  <tr>
					...
					<th>Vaccination Details
					<th>Next vaccination Date
					...
					$sql="select * from vcdet where oname='$username'";
