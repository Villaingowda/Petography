    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <a href="bapp1.php"><button type="button" class="btn btn-info">Book Appointment</button></a>
				<a href="vapp.php"><button type="button" class="btn btn-info">View Appointment Status</button></a>
