        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
					...
					<a href="buy1.php" class="nav-item nav-link active">Buy</a>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                <h4 class="text-secondary mb-3">Buy Product</h4>
                
                <form name="f" method="post" action="buy4.php">
								...
								<input type="text" class="form-control" name="t4"required value="<?php echo $bname; ?>">
								</div>
								
																
								<div class="form-group">
								<label>Price:</label>
								<input type="number" class="form-control" name="t6" required maxlength=10 value="<?php echo $price; ?>">
								</div>
								
								<div class="form-group">
								<label>Quantity:</label>
								<input type="number" class="form-control" name="t7" required>
								</div>
								<br>
								<div class="form-group">
								<label>Uploaded By:</label>
								<input type="text" class="form-control" name="t8" value="<?php echo $uby; ?>" required>
								</div>
								<br>
