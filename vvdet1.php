...
document.getElementsByName("t9")[0].setAttribute('min', today);
    }
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="vhomepage.php" class="nav-item nav-link">Home</a>
                    <a href="upload.html" class="nav-item nav-link">Upload Product</a>
                    <a href="vapp1.php" class="nav-item nav-link">Appointments</a>
                    <a href="vvdet.php" class="nav-item nav-link active">Vaccination Details</a>
...
$sql="select * from appdet where aid='$id'";
    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                <h4 class="text-secondary mb-3">Vaccination Details</h4>
                
                <form name="f" method="post" action="vvdet2.php">

								<div class="form-group">
								<label>Appointment ID:</label>
								<input type="text" class="form-control" name="t1" required value="<?php echo $aid; ?>">
								</div>
								
								<div class="form-group">
								<label>Appointment Date:</label>
								<input type="text" class="form-control" name="t2" required value="<?php echo $adate; ?>">
								</div>
								
								<div class="form-group">
								<label>Pet Type:</label>
								<input type="text" class="form-control" name="t3" required value="<?php echo $ptype; ?>">
								</div>
								
								<div class="form-group">
								<label>Breed:</label>
								<input type="text" class="form-control" name="t4" required value="<?php echo $breed; ?>">
								</div>
								
								<div class="form-group">
								<label>Age:</label>
								<input type="text" class="form-control" name="t5" required value="<?php echo $age; ?>">
								</div>
								
								<div class="form-group">
								<label>Owner Name:</label>
								<input type="text" class="form-control" name="t6" required value="<?php echo $oname; ?>">
								</div>
								
								<div class="form-group">
								<label>Contact Number:</label>
								<input type="text" class="form-control" name="t7" required value="<?php echo $ocno; ?>">
								</div>
								
								<div class="form-group">
							<label>Vaccination Details</label>
							<textarea rows=4 cols=10 class="form-control" name="t8"></textarea>
							
							<div class="form-group">
								<label>Next vaccination Date:</label>
								<input type="date" class="form-control" name="t9" required value="<?php echo $ocno; ?>">
								</div>
