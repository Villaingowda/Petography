...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="admhomepage.php" class="nav-item nav-link active">Home</a>
                    <a href="apdet.html" class="nav-item nav-link">Product Details</a>
                    <a href="aoh.php" class="nav-item nav-link">Order History</a>
					<div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Reports</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="pdetrep.html" class="dropdown-item">Pet Details</a>
                            <a href="prodrep.html" class="dropdown-item">Product Details</a>
							<a href="vetrep.html" class="dropdown-item">Vet Details</a>
                        </div>
                    </div>
    ...
    <div class="container py-5">
        <div class="row py-5">
		<h4 class="text-secondary mb-3">Product Report</h4>
		<table id="customers" border="1" cellpadding="5" cellspacing="5">
				  <tr>
					...
					while($row = $result->fetch_assoc())
					{
						...
						echo "<td>".$mname;
						echo "<td>".$price;
						echo "<td><img src='".$photo."' width=100 height=100>";
