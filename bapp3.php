...
document.getElementsByName("t6")[0].setAttribute('min', today);
    }
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="app1.php" class="nav-item nav-link active">Appointments</a>
...
$sql="select * from vdet where username='$id'";
    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                <h4 class="text-secondary mb-3">Book Appointments</h4>
                
                <form name="f" method="post" action="bapp4.php">

								<div class="form-group">
								<label>Doctor Name:</label>
								<input type="text" class="form-control" name="t1" required value="<?php echo $id; ?>">
								</div>
								
								<div class="form-group">
								<label>Clinic Name:</label>
								<input type="text" class="form-control" name="t2" required value="<?php echo $lname; ?>">
								</div>
								
								<div class="form-group">
								<label>Address:</label>
								<input type="text" class="form-control" name="t3"required value="<?php echo $addr; ?>">
								</div>
								
																
								<div class="form-group">
								<label>Contact Number:</label>
								<input type="number" class="form-control" name="t4" required maxlength=10 value="<?php echo $cno; ?>">
								</div>
								<div class="form-group">
								<label>Reason for Appointment:</label>

								<textarea rows=4 cols=10 class="form-control" name="t5" required></textarea>
								</div>
								
								<div class="form-group">
								<label>Appointment Date:</label>
								<input type="date" class="form-control" name="t6" required>
								</div>
