    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <h1 class="display-4 mb-4"><span class="text-primary">Update</span> <span class="text-secondary">Info</span></h1>
                <form name="f" method="post" action="vupdate2.php">

								
								<div class="form-group">
								<label>First Name:</label>
								<input type="text" class="form-control" name="t3" required value="<?php echo $fname; ?>">
								</div>
								
								<div class="form-group">
								<label>Last Name:</label>
								<input type="text" class="form-control" name="t4"required value="<?php echo $lname; ?>">
								</div>
								
								<div class="form-group">
								<label>Address:</label>
								<textarea rows=5 cols=10 class="form-control" name="t5" required><?php echo $addr; ?></textarea>
								</div>
								
								<div class="form-group">
								<label>Mobile Number:</label>
								<input type="number" class="form-control" name="t6" required maxlength=10 value="<?php echo $cno; ?>">
								</div>
								
								<div class="form-group">
								<label>Email ID:</label>
								<input type="email" class="form-control" name="t7" required value="<?php echo $email; ?>">
								</div>
								<br>
								<div class="form-group">
							<label>Select Location</label>
							<select class="form-control" name="t8">
							<option value="Kumaraswamy-Layout">Kumaraswamy Layout
							<option value="Uttarahalli">Uttarahalli
							<option value="Sri-Nagar">Sri Nagar
							<option value="Vijay-Nagar">Vijay Nagar
							<option value="Rajajai-Nagar">Rajajai Nagar
							<option value="Jayanagar">Jayanagar
							<option value="JP-Nagar">JP Nagar
							<option value="White-Field">White Field
							<option value="Koramangala">Koramangala
							<option value="HSR-Layout">HSR Layout
							<option value="BTM-Layout">BTM Layout
							<option value="Electronic-City">Electronic City
							</select>
