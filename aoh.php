        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="admhomepage.php" class="nav-item nav-link">Home</a>
                    <a href="apdet.html" class="nav-item nav-link">Product Details</a>
                    <a href="aoh.php" class="nav-item nav-link active">Order History</a>
					<a href="achangepass.html" class="nav-item nav-link">Change Password</a>
                    <a href="alogout.html" class="nav-item nav-link">Logout</a>
                </div>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <h1 class="display-4 mb-4"><span class="text-primary">Search</span> <span class="text-secondary">Product</span></h1>
                <form name="f" method="post" action="aoh1.php">
						...
						<div class="form-group">
							...
							<option value="First-Aid-Kit">First Aid Kit
							<option value="Grooming-Brush">Grooming Brush
							<option value="Nail-Trimmer">Nail Trimmer
							<option value="Flea-Preventative">Flea Preventative
							<option value="Stain-and-Odor-Remover">Stain and Odor Remover
							</select>
						</div>
